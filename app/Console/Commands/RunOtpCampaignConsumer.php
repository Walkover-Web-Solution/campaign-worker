...
class RunOtpCampaignConsumer extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'otp:Comsume';
     ...
     * @var string
     */
    protected $description = 'Otp consume command';
    ...
    public function decodedData($msg)
    {
        ...
        try {
            ...
            $this->rabbitmq->putInFailedQueue('failed_run_otp_campaigns', $msg->getBody());
        }
        $msg->ack();
    }
}
