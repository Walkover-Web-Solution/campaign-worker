...
sudo /usr/bin/php /var/app/current/artisan rabbitmq:queue-declare "run_whatsapp_campaigns"
...
sudo /usr/bin/php /var/app/current/artisan rabbitmq:queue-declare "failed_run_whatsapp_campaigns"
